...
test('buttons > calls the bold method', (t) => {
  ...
  t.equal(editor._marky.html, '<p><strong>Some text</strong></p>\n')
  t.end()
})
...
test('buttons > calls the italic method', (t) => {
  ...
  t.equal(editor._marky.html, '<p><em>Some text</em></p>\n')
  t.end()
})
...
test('buttons > calls the strikethrough method', (t) => {
  ...
  t.equal(editor._marky.html, '<p><del>Some text</del></p>\n')
  t.end()
})
...
test('buttons > calls the code method', (t) => {
  ...
  t.equal(editor._marky.html, '<p><code>Some text</code></p>\n')
  t.end()
})
...
test('buttons > calls the blockquote method', (t) => {
  ...
  t.equal(editor._marky.html, '<blockquote>\n<p>Some text</p>\n</blockquote>\n')
  t.end()
})
...
test('buttons > does not call the undo method if disabled', (t) => {
  ...
  t.equal(editor._marky.html, '<p>Some really super funny awesome crazy text</p>')
  t.end()
})
...
test('buttons > calls the redo method', (t) => {
  ...
  t.equal(editor.value, 'Some text')
  t.equal(editor._marky.html, '<p>Some text</p>')
  t.end()
})
