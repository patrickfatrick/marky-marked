...
describe('toolbar buttons', () => {
  ...
  it('calls the undo method', () => {
    ...
    editor._marky.html = '<p>Some super really funny awesome crazy text</p>'
    editor._marky.state = [
    ...
    assert.strictEqual(editor._marky.html, '<p>Some really funny awesome text</p>')
  })
  it('does not call the undo method if disabled', () => {
    ...
    assert.strictEqual(editor._marky.html, '<p>Some super really funny awesome crazy text</p>')
  })
  ...
  it('does not call the redo method if disabled', () => {
    ...
    assert.strictEqual(editor._marky.html, '')
  })
  it('turns on expanded view', () => {
    const container = document.querySelector('marky-mark')
    const editor = document.querySelector('.marky-editor')

    document.querySelector('.expand').click()

    assert.isTrue(container.classList.contains('marky-expanded'))
    assert.isTrue(editor.classList.contains('marky-expanded'))
  })
  it('turns off expanded', () => {
    const container = document.querySelector('marky-mark')
    const editor = document.querySelector('.marky-editor')

    document.querySelector('.expand').click()

    assert.isFalse(container.classList.contains('marky-expanded'))
    assert.isFalse(editor.classList.contains('marky-expanded'))
  })
})
