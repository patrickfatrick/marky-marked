...
Object.defineProperty(exports,'__esModule',{value:true});exports.Marky=undefined;var _mark=__webpack_require__(40);var _mark2=_interopRequireDefault(_mark);var _dispatcher=__webpack_require__(38);var dispatcher=_interopRequireWildcard(_dispatcher);var _customEvents=__webpack_require__(19);var _handlers=__webpack_require__(39);function _interopRequireWildcard(obj){if(obj&&obj.__esModule){return obj}else{var newObj={};if(obj!=null){for(var key in obj){if(Object.prototype.hasOwnProperty.call(obj,key))newObj[key]=obj[key]}}newObj.default=obj;return newObj}}function _interopRequireDefault(obj){return obj&&obj.__esModule?obj:{default:obj}}var Marky=exports.Marky={init:function init(){var container=arguments.length>0&&arguments[0]!==undefined?arguments[0]:null;var editor=arguments.length>1&&arguments[1]!==undefined?arguments[1]:null;this.mark=_mark2.default;this.editor=editor;this.container=container;this.state=[{markdown:'',html:'',selection:[0,0]}];this.index=0;this.markdown='';this.html='';this.listeners=[]},/**
   ...
   */updateMarkdown:function updateMarkdown(markdown){this.markdown=markdown},/**
   * Handles updating the hidden input's value as well as html prop
   * @param  {String} html   an HTML string
   */updateHTML:function updateHTML(html){this.html=html},/**
...
"use strict";
/* global HTMLCollection HTMLElement NodeList */Object.defineProperty(exports,'__esModule',{value:true});var _create=__webpack_require__(0);var _create2=_interopRequireDefault(_create);exports.default=function(){var containers=arguments.length>0&&arguments[0]!==undefined?arguments[0]:document.getElementsByTagName('marky-mark');if(!(containers instanceof Array)&&!(containers instanceof HTMLCollection)&&!(containers instanceof NodeList)){throw new TypeError('`containers` argument should be an Array or HTMLCollection')}var idArr=[];// Ultimately this is what is returned
var markies=[];Array.prototype.forEach.call(containers,function(container,i){if(!(container instanceof HTMLElement)){throw new TypeError('`containers` argument should only contain HTMLElements')}var idIndex=i;/**
